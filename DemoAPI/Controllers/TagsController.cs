...
namespace DemoAPI.Controllers
{
    ...
    public class TagsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public ActionResult GetTagsById(int id)
        {
        ...
        [HttpPost]
        public ActionResult Create([FromBody] CreateTagDTO createTagDTO)
        {
            var tag = new Tag
            {
        ...
        [HttpPut("{id}")]
        public ActionResult Update(int id, [FromBody] CreateTagDTO updateTagDTO)
        {
            var tag = _tagRepository.GetById(id);
